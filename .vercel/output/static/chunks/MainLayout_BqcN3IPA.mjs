import { c as createAstro, a as createComponent, r as renderTemplate, u as unescapeHTML, b as addAttribute, d as renderComponent, F as Fragment, m as maybeRenderHead, e as renderScript, f as renderSlot, g as renderHead } from './astro/server_CKj95Dky.mjs';
import 'kleur/colors';
import { g as getImage, $ as $$Image } from './_astro_assets_Cru6olkC.mjs';
import { i as icon } from './icon_D9Pgd5Kf.mjs';
import 'clsx';
/* empty css                          */
...
const ogImageSrc = new Proxy({"src":"/_astro/social.CWnIx2-K.png","width":1200,"height":600,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/gg/iost/demo/YST_front/src/images/social.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/gg/iost/demo/YST_front/src/images/social.png");
							return target[name];
						}
					});
...
const faviconSvgSrc = new Proxy({"src":"/_astro/icon.B7KHh505.svg","width":512,"height":512,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/gg/iost/demo/YST_front/src/images/icon.svg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/gg/iost/demo/YST_front/src/images/icon.svg");
							return target[name];
						}
					});
...
}, "/Users/gg/iost/demo/YST_front/src/components/Meta.astro", void 0);
...
}, "/Users/gg/iost/demo/YST_front/src/components/ThemeIcon.astro", void 0);
...
}, "/Users/gg/iost/demo/YST_front/src/components/ui/icons/Icon.astro", void 0);
...
const $$LanguagePicker = createComponent(($$result, $$props, $$slots) => {
  ...
  Object.entries(languages).map(([lang, label]) => renderTemplate`<a class="flex items-center gap-x-3.5 rounded-lg px-3 py-2 text-sm text-neutral-800 hover:bg-neutral-100 focus:bg-neutral-100 focus:outline-none dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"${addAttribute(`/${lang === "en" ? "" : lang}`, "href")}> ${label} </a>`)} </div> </div> <!--Import the necessary Dropdown plugin--> <!--https://preline.co/plugins/html/dropdown.html--> ${renderScript($$result, "/Users/gg/iost/demo/YST_front/src/components/ui/LanguagePicker.astro?astro&type=script&index=0&lang.ts")} ${renderScript($$result, "/Users/gg/iost/demo/YST_front/src/components/ui/LanguagePicker.astro?astro&type=script&index=1&lang.ts")}`;
}, "/Users/gg/iost/demo/YST_front/src/components/ui/LanguagePicker.astro", void 0);

const logoImageSrc = new Proxy({"src":"/_astro/logo-b.in8eH3m_.jpg","width":998,"height":375,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/gg/iost/demo/YST_front/src/images/logo-b.jpg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/gg/iost/demo/YST_front/src/images/logo-b.jpg");
							return target[name];
						}
					});
...
}, "/Users/gg/iost/demo/YST_front/src/components/ui/links/FooterSocialLink.astro", void 0);
...
</p> </div> <!-- Social Brands --> <div> ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.facebook }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "facebookFooter" })} ` })} ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.x }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "xFooter" })}` })} ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.github }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "githubFooter" })} ` })} ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.google }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "googleFooter" })} ` })} ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.slack }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "slackFooter" })} ` })} </div> </div> ${renderScript($$result, "/Users/gg/iost/demo/YST_front/src/components/sections/navbar&footer/FooterSection.astro?astro&type=script&index=0&lang.ts")} </div> </footer>`;
}, "/Users/gg/iost/demo/YST_front/src/components/sections/navbar&footer/FooterSection.astro", void 0);
